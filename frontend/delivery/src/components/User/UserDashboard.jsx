    ...
    return (
      <div className="max-w-6xl mx-auto p-6">
        <div className="text-center p-8 bg-red-50 rounded-xl border border-red-200">
          ...
          <h2 className="text-red-600 font-medium text-lg mb-2">
      ...
      <div className="flex flex-wrap justify-between items-center mb-10 gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Easily track and manage your shipments in one place.
          </p>
        </div>
        <Link
          to="/create"
                ...
                {parcels.map((parcel) => (
                  <tr key={parcel.id} className="hover:bg-gray-50 transition">
                    <td className="px-6 py-4 font-semibold text-gray-900">
                      #{String(parcel.id).slice(0, 8)}
                    </td>
                    <td className="px-6 py-4 max-w-[220px] truncate text-gray-700">
                      {parcel.description}
                    </td>
